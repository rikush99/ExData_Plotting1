...
plot(VarR[, dateTime], VarR[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

plot(VarR[, dateTime],VarR[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
plot(VarR[, dateTime], VarR[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
